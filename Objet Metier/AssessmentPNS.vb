        ...
        Get
            If IsNothing(_PrecalculedValue) Then
                ...
                For Each uneLigne In db.P_Assessment_Values_PNS(Me.idSupplier, Me.quarter)
                    ...
                    Dim _order_horizon_percentage_greather_than_12 As Double = CInt(IIf(IsNothing(uneLigne.ORDER_HORIZON_GREATER_THAN_12_RATE), 0, uneLigne.ORDER_HORIZON_GREATER_THAN_12_RATE))
